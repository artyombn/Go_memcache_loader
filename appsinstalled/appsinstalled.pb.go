...
type UserApps struct {
	...
	Apps          []uint32               `protobuf:"varint,1,rep,packed,name=apps,proto3" json:"apps,omitempty"`
...
const file_appsinstalled_appsinstalled_proto_rawDesc = "" +
	"\n" +
	"!appsinstalled/appsinstalled.proto\"\\\n" +
	"\bUserApps\x12\x12\n" +
	"\x04apps\x18\x01 \x03(\rR\x04apps\x12\x15\n" +
	"\x03lat\x18\x02 \x01(\x01H\x00R\x03lat\x88\x01\x01\x12\x15\n" +
	"\x03lon\x18\x03 \x01(\x01H\x01R\x03lon\x88\x01\x01B\x06\n" +
	"\x04_latB\x06\n" +
	"\x04_lonB6Z4github.com/artyombn/Go_memcache_loader/appsinstalledb\x06proto3"

var (
	file_appsinstalled_appsinstalled_proto_rawDescOnce sync.Once
	file_appsinstalled_appsinstalled_proto_rawDescData []byte
)

func file_appsinstalled_appsinstalled_proto_rawDescGZIP() []byte {
	file_appsinstalled_appsinstalled_proto_rawDescOnce.Do(func() {
		file_appsinstalled_appsinstalled_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_appsinstalled_appsinstalled_proto_rawDesc), len(file_appsinstalled_appsinstalled_proto_rawDesc)))
	})
...
var file_appsinstalled_appsinstalled_proto_goTypes = []any{
...
func file_appsinstalled_appsinstalled_proto_init() {
	...
	file_appsinstalled_appsinstalled_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_appsinstalled_appsinstalled_proto_rawDesc), len(file_appsinstalled_appsinstalled_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
